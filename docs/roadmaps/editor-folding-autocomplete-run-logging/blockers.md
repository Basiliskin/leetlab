...
- 2026-08-30 | horizon 1 | Which concrete object shape did the implementer use for the run-log `result` second argument (LastRun summary vs raw {results,logs})? — RESOLVED 2026-08-30 horizon 1 phase 3: used the LastRun summary (same object passed to setLastRun at each of the three post-dispatch sites).
